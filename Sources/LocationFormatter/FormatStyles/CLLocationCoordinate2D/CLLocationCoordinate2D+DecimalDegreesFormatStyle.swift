...
extension CLLocationCoordinate2D.DecimalDegreesFormatStyle: Foundation.FormatStyle {
...
public extension CLLocationCoordinate2D.DecimalDegreesFormatStyle {
    struct ParseStrategy: Foundation.ParseStrategy {
        ...
        public func parse(_ value: String) throws -> CLLocationCoordinate2D {
            ...
            let latitude = try CLLocationDegrees.DecimalDegreesFormatStyle.ParseStrategy(
                orientation: .latitude,
                options: options
            ).parse(components[0])
            
            let longitude = try CLLocationDegrees.DecimalDegreesFormatStyle.ParseStrategy(
